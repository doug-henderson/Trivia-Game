...
// this game object holds all of the questions, possible answers, and then the index of the correct answer for each
	var game = {
		questions: [
		{
	   		...
	   		possibles: ['Raymond Orteig', 'Dwane Wallace', 'Charles Lindbergh', 'Steve Fossett'],
	   		id: 'question-one',
	   		answer: 2
		}, {
			question: 'Which U.S. president had a home called The Hermitage?',
			possibles: ['Martin Van Buren', 'Andrew Jackson', 'James Buchanan', 'Abraham Lincoln', 'Evanston'],
			id: 'question-two',
			answer: 1
		}, {
			question: 'In which sport do teams compete for the Stanley Cup?',
			possibles: ['Football', 'Baseball', 'Soccer', 'Ice Hockey'],
			id: 'question-three',
			answer: 3
		}, {
			question: 'Name the world\'s largest ocean.?',
			possibles: ['Atlantic', 'Pacific', 'Indian', 'Artic'],
			id: 'question-four',
			answer: 1
		}, {
			question: 'What is the world\'s longest river?',
			possibles: ['Amazon', 'Colorado', 'Mississippi', 'Nile', 'Yukon'],
			id: 'question-five',
			answer: 0
		}, {
			question: 'How many valves does a trumpet have?',
			possibles: ['Two', 'Three', 'Four', 'One'],
			id: 'question-six',
			answer: 1

		}, {
			question: 'When did the Cold War end?',
			possibles: ['1991', '1985', '1989', '1988', '1998'],
			id: 'question-seven',
			answer: 2
		}, {
			question: 'Who wrote the Vampire Chronicles, which include the novels Armand, Blood and Gold and Interview with the Vampire?',
			possibles: ['Steven King', 'Helen Dunmore', 'Thomas Mann', 'Anne Rice'],
			id: 'question-eight',
			answer: 4
		}, {
			question: 'Name the seventh planet from the sun.',
			possibles: ['Mercury', 'Jupiter', 'Uranus', 'Venus:', 'Mars'],
			id: 'question-nine',
			answer: 2
		}, {
